...
|                                   | AtrialFibrillation                    | ECG                                          | /          | 5 second segments of atrial fibrillation, containing two ECG signals   | each sampled at 128 samples per second. The class labels are: n, s and t. Train size:15;Test size:15                       |
|                                   | Blink                                 | EEG                                          | /          | Collected in 20 trials of six patients, with 50 blinks per experiment. | Each sample is 510 values long, with 4 EEG channels, representing 2 seconds sampled at 255Hz. Train size:500;Test size:450 |
